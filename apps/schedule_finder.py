...
from apps._fun import schedule_seperate_graph, LinModel
...
layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            dbc.Button("Automatically Detect Schedule", color="primary", className="me-1"),
            html.Br(),
        ...
        dbc.Col([
            ...
            dbc.Button("Automatically Detect Schedule", id='water-find-sch', color="primary"),
            html.Br(),
            html.P("Manually Adjust Schedule",
                   className="font-weight-bolder"),
        ...
        dbc.Col([
            ...
            dbc.Button("Automatically Detect Schedule", color="primary"),
            html.Br(),
            html.P("Manually Adjust Schedule",
                   className="font-weight-bolder"),
...
def page_load_trigger_sch(t):
    ...
    return building, year, steam_sch, water_sch, elec_sch
...
def train_steam_model(n, data, building, year, steam_sch, water_sch, elec_sch, steam_line, water_line, elec_line):
    if n is not None:
        data = pd.read_json(data, orient='split')
        steam_model_on, steam_model_off, steam_model_r2 = LinModel(data, steam_sch, 'steam', WeekendSplit=True)
        water_model_on, water_model_off, water_model_r2 = LinModel(data, water_sch, 'chilledWater', WeekendSplit=True)
        elec_model_on, elec_model_off, elec_model_r2 = LinModel(data, elec_sch, 'electricity', WeekendSplit=True)
